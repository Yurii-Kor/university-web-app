...
import ua.foxminded.university.model.repository.dto.TeacherWithCoursesCount;
...
public interface TeacherRepository extends JpaRepository<Teacher, Long> {
    ...
    @Query("""
            select new ua.foxminded.university.model.repository.dto.TeacherWithCoursesCount(
                t,
                count(c.id)
            )
            from Teacher t
