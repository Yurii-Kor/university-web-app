...
public class StudentCoursesPageStrategy implements CoursesPageStrategy {

    private final CourseService courseService;

    @Override
    public CoursesPageMode mode() {
        return CoursesPageMode.STUDENT;
    }

    @Override
    public Page<CourseCardView> loadCourses(long userId, Pageable pageable) {
        return courseService.listCourseCardsForStudent(userId, pageable);
    }
}